...
export default function LoginPage() {
  ...
  const handleGoogleSignIn = async () => {
    ...
    // window.location.origin is always correct for the environment you're
    // actually running in (localhost in dev, your real domain in prod) —
    ...
    // On success, Supabase performs the redirect itself — no further
    // action needed here.
  };
